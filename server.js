...
* 
*  Name:Shagun Rani Student ID:166470211 Date:2023-04-14
*
...
cloudinary.config({
    cloud_name: "dxp6fv3bz",
    api_key: "154999453167374",
    api_secret: "r7ncS9LNOTE1myhRiV-hm08BR8c"
...
app.use(clientSessions({
    cookieName: 'session',
    secret: 'your-secret-string', //week10example_web322
...
app.get('/login', function(req, res){
  ...
  // Define the 404 middleware function
  app.use((req, res) => {
